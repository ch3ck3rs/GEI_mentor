...
with st.beta_expander('Areas of Mentorship'):
...
summary_text = f"This survey had {respondents} respondents and was administered \
    the week of {start_date}.  The average time for completion was 10 min. \n \
\n Of the {respondents} respondents, {desire['Yes']+addnl['Yes']} would like to \
    have a mentor.  Most respondents do not have a preference for a mentor inside \
...
with st.beta_expander('Tabular results after basic cleaning and tidying have been performed. '):
    survey_bin